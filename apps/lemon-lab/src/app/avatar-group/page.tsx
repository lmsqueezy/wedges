      ...
      <div className="mt-24 flex flex-col gap-24">
          ...
          <section className="mt-24">
            ...
            <AvatarGroup
              items={[
                ...
                {
                  src: "zhttps://images.unsplash.com/photo-1544723795-3fb6469f5b39?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mzl8fHBlcnNvbnxlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=250&q=60",
                  alt: "A picture of a person",
                },
                {
                  src: "https://images.unsplash.com/photo-1589571894960-20bbe2828d0a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NTR8fHBlcnNvbnxlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=250&q=60",
        ...
        <section>
          ...
          <AvatarGroup.Root>
            ...
            <AvatarGroup.Label className="z-40 bg-primary px-3 text-sm text-white">
              3,000 followers
            </AvatarGroup.Label>
