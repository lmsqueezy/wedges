...
`,
  ...
  "tag/example-1": {
    ...
    code: `import * as React from "react";
import { BookIcon, FileIcon, FolderIcon } from "@iconicicons/react";
...
export function Example() {
  return (
    <div className="mx-auto flex max-w-fit flex-col items-start gap-4">
      ...
      <div className="flex flex-wrap items-center justify-start gap-4">
        <Tag before={<IconUK />} closable>
          United Kingdom
        </Tag>

        <Tag before={<IconUS />} closable>
          United States
        </Tag>
      </div>
    </div>
...
const IconUS = React.forwardRef<SVGSVGElement, React.SVGAttributes<SVGSVGElement>>((props, ref) => {
  return (
...
const IconUK = React.forwardRef<SVGSVGElement, React.SVGAttributes<SVGSVGElement>>((props, ref) => {
  return (
    <svg width="25" height="24" viewBox="0 0 25 24" fill="none" {...props} ref={ref}>
      <path
        d="M12.5 22C18.0228 22 22.5 17.5228 22.5 12C22.5 6.47715 18.0228 2 12.5 2C6.97715 2 2.5 6.47715 2.5 12C2.5 17.5228 6.97715 22 12.5 22Z"
