...
```tsx showLineNumbers
<Avatar alt='Image alt text' src="https://images.unsplash.com/photo-1517841905240-472988babdf9?w=250&h=250&auto=format&fit=crop" />
```
...
Includes all the props of the `AvatarImage` <a href="https://www.radix-ui.com/primitives/docs/components/avatar#image" rel="nofollow noreferrer" target="_blank">Radix</a> primitive and:
...
See `AvatarRoot` <a href="https://www.radix-ui.com/primitives/docs/components/avatar#root" target="_blank" rel="nofollow noreferrer">Radix</a> primitive.

#### Avatar.Image

See `AvatarImage` <a href="https://www.radix-ui.com/primitives/docs/components/avatar#image" target="_blank" rel="nofollow noreferrer">Radix</a> primitive.

#### Avatar.Fallback

See `AvatarFallback` <a href="https://www.radix-ui.com/primitives/docs/components/avatar#fallback" target="_blank" rel="nofollow noreferrer">Radix</a> primitive.
