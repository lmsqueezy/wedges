...
<PropsTable
  content={[
    ...
    [
      { value: "children", description: "Used as a secondary text." },
      { value: 'ReactNode' },
      {  },
    ],
    [
    ...
    [
      { value: "closable", description: "Is the alert closable? If true, a close button will be displayed and when clicked on it will hide the alert element." },
      { value: 'boolean' },
      { value: 'false' },
    ],
    [
      { value: "onClose", description: "An optional callback function to be called when the close button is clicked. Requires the `closable` prop to be set to `true`." },
