...
Represents label in the avatar group. In addition to all the props of the `HTMLAttributes<HTMLDivElement>`, `AvatarGroup.Label` component also includes the following props:
