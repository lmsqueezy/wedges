    ...
    [
      {
        value: "disabled",
        description:
          "If set to `true`, additional styles will be applied to the field to indicate that it is disabled.",
      },
      {
        value: "boolean",
      },
    ...
    [
      {
        value: "required",
        description:
          "If set to `true`, additional styles will be applied to the label to indicate that the field is required.",
      },
      { value: "boolean" },
      { value: "false" },
    ],
