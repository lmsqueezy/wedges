...
isOptions
  content={[
    [{ value: "fontSmooth", description: "Font smoothing of Wedges components." }, { value: '"antialiased" | "inherit"' }, { value: '"antialiased"' }],
    [{ value: "prefix", description: "The prefix for Wedges CSS variables." }, { value: "string" }, { value: '"wg"' }],
    [{ value: "themes", description: "Themes configuration" }, { value: "ConfigThemes" }, { value: "{}" }],
...
<html class="light">
    ...
    <div class="dark">...</div>
    <div class="orange-blue">...</div><!-- custom theme -->
</html>
```
